...
begin 
    Ada.Text_IO.Put_Line("The min range of an integer [" &
        Integer'Image(Integer'First) &"] and the max range of an integer [" &
        Integer'Image(Integer'Last) &"].");
    Ada.Text_IO.Put_Line("The min range of a positive [" &
        Positive'Image(Positive'First) & "] and the max range of a positive [" &
        Positive'Image(Positive'Last) & "].");
    Ada.Text_IO.Put_Line("The min range of a natural [ " &
