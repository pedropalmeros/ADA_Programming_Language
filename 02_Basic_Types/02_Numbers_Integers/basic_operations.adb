...
begin
    ...
    Ada.Text_IO.Put_Line("This is the integer: " &
        Integer'Image(TestInteger));
    
    -- do some basic operations on the Natural. 
    TestNatural := TestNatural + 25;
    Ada.Text_IO.Put_Line("This is the natural: " &
        Natural'Image(TestNatural));
    
    -- do some basic operations on the Positive
    TestPositive := TestPositive + 8;
    Ada.Text_IO.Put_Line("This is the positive: " & 
        Positive'Image(TestPositive));
