...
begin
    case SomeVal is 
        ...
        when others =>
            Ada.Text_IO.Put_Line("The value is not a valid option");
    end case;
    ...
    case Today is
        ...
        when Wednesday|Thursday|Friday =>
            Ada.Text_IO.Put_Line("todayis either Wednesday, Thursday or Friday");
        when Saturday|Sunday =>
            Ada.Text_IO.Put_Line("Today is weekend.");
        when others => 
            Ada.Text_IO.Put_Line("I don't know what day is today");
        end case;
        Ada.Text_IO.New_Line(2);
end case_statement;